...
if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit") {
    $Id = $_GET['Id'];
    $query = mysqli_query($conn, "SELECT * FROM tblcource WHERE Id ='$Id'");
    ...
    if (isset($_POST['update'])) {
      ...
      session='$session', description='$description', image='$target_file', updatedAt='$updatedAt'
      WHERE Id='$Id'");
                                            ...
                                            <div class="form-group row mb-3">
                                                <div class="col-xl-6">
                                                    ...
                                                    <input type="text" class="form-control" name="session"
                                                        value="<?php echo $row['session']; ?>" id="exampleInputFirstName">
                                                </div>
                                                <div class="col-xl-6">
